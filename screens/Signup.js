    ...
    render() {
      ...
      >
        <SafeAreaView style={styles.safeview}>
          <View style={{flex:1,flexDirection:'row',justifyContent:"center",marginTop:"2%",marginLeft:"2%"}}>
          ...
          <View style={styles.defaultPlace}>
            ...
            />
            {this.state.passwordVisibility? <Icon name="eye"
            type="font-awesome"
            size={25}
            onPress={this.handlePasswordVisibility}
        />:<Icon name="eye-slash" type="font-awesome" size={25} onPress={this.handlePasswordVisibility} />}
          ...
          <View style={styles.defaultPlace}>
            ...
            />
            {this.state.confirmpasswordVisibility? <Icon name="eye"
            type="font-awesome"
            size={25}
            onPress={this.handleConfirmPasswordVisibility}
        />:<Icon name="eye-slash" type="font-awesome" size={25} onPress={this.handleConfirmPasswordVisibility} />}
